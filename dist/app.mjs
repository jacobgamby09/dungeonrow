...
function render(){
  ...
  const allBlocked=!!p.attacker&&p.damage===0;
...
function selectEffect(key){
  ...
  if(!e)return;
  if(e.type==='heal'||e.type==='block'){
    const enabled=game.assignments[key]==='self';
    assign(game,id,Number(index),enabled?null:'self');selected=null;selectedCard=null;
